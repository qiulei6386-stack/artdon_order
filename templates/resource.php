...
<?php else: ?>
<div class="resource-toolbar"><label><?= icon('search') ?><input type="search" placeholder="Search model, series or file name" data-resource-search></label><select><option>All series</option><option>AL10</option><option>AT20</option><option>MW30</option></select><select><option>Latest revision</option><option>Most downloaded</option></select></div>
...
<a class="resource-row" href="#" data-demo-download data-search="<?= e(strtolower($p['sku'].' '.$p['name'].' '.$page['title'])) ?>"><span><?= icon('file') ?><b><?= e($p['sku'].' '.$page['title']) ?></b><small><?= e($p['name']) ?></small></span><span><?= e($p['series'].' / '.$p['sku']) ?></span><span>R<?= str_pad((string)$i,2,'0',STR_PAD_LEFT) ?></span><span><?= (2+$i) ?>.<?= $i ?> MB</span><span><?= icon('download') ?></span></a>
<?php endfor; ?>
</div>
